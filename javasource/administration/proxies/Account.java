...
public class Account extends system.proxies.User
{
	 ...
	 */
	public final shelterbox_ui_resources.proxies.Photo getPhoto_Account() throws com.mendix.core.CoreException
	{
	 ...
	 * @return value of Photo_Account
	 */
	public final shelterbox_ui_resources.proxies.Photo getPhoto_Account(com.mendix.systemwideinterfaces.core.IContext context) throws com.mendix.core.CoreException
	{
		shelterbox_ui_resources.proxies.Photo result = null;
		...
		if (identifier != null)
			result = shelterbox_ui_resources.proxies.Photo.load(context, identifier);
		return result;
	}
	 ...
	 * @param photo_account
	 */
	public final void setPhoto_Account(shelterbox_ui_resources.proxies.Photo photo_account)
	{
	 ...
	 * @param photo_account
	 */
	public final void setPhoto_Account(com.mendix.systemwideinterfaces.core.IContext context, shelterbox_ui_resources.proxies.Photo photo_account)
	{
